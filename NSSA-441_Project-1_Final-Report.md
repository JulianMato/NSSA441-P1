...
For this experement we generated 5 minutes worth of trafic 5 times then graphed it. We did this once from one pod to the other in other words inter pod, then betwen two hosts in one pod or intra pod. Once the data is taken it is averaged, we then find the time loss from entering the core by subtracting the intra pod trafic from the inter pod trafic. This helps us establish the speed loss due to aditional hops.
<br>
<br>
